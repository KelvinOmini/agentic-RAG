import os
os.environ["USER_AGENT"] = "Mozilla/5.0 (compatible; AgenticRAGBot/1.0; +http://yourdomain.com/bot)"
import tempfile
...
def process_web(url: str) -> List:
    ...
    requests_kwargs={
        "headers": {
            "User-Agent": "Mozilla/5.0 (compatible; AgenticRAGBot/1.0; +http://yourdomain.com/bot)"
        }
    }
)
        documents = loader.load()
